...
public:
    ...
    ParamServer()
    {
        ...
        nh.param<std::string>("lio_sam/savePoseDirectory", savePoseDirectory, "/home/tkw/AAA_baseline/LIOSAM/src/LIO-SAM/path/lio_sam.txt");
        ...
        nh.param<bool>("lio_sam/printPerformanceTimer", printPerformanceTimer, true);
